...
const BreweryCard = ({ brewery }) => {
  return (
    <div className="rounded p-6 shadow-lg m-4 flex-1 h-52">
      ...
      <div className="flex flex-col items-center justify-center my-3 text-center">
        ...
        <p className="text-sm my-3">{`${brewery.address_1} ${brewery.city}, ${brewery.state_province} ${brewery.postal_code}`}</p>
